...
class  hack_upgrade(BodyMod):
    def __init__(self) -> None:
        super().__init__(bodypart=BodyPart.HEAD, name="Neural Enhancer",focus_bonus = 2)
...
class   accuracy_upgrade(BodyMod):
    def __init__(self) -> None:
        super().__init__(bodypart=BodyPart.HEAD, name="Integrated Fire Control",accuracy_bonus=4)
class   control_upgrade(BodyMod):
    def __init__(self) -> None:
        super().__init__(bodypart=BodyPart.HEAD, name="Network Interface Adapter",perk="control")


class shielding(BodyMod):
    def __init__(self) -> None:
        super().__init__(bodypart=BodyPart.BODY, name="Kinetic Plating",health_bonus= 8)
class electrical_shielding(BodyMod):
    def __init__(self) -> None:
...
class reflex_upgrade(BodyMod):
    def __init__(self) -> None:
        super().__init__(bodypart=BodyPart.ARMS, name="Rapid Response Servos",reflex_bonus=2)
class bionic_arm(BodyMod):
    def __init__(self) -> None:
        super().__init__(bodypart=BodyPart.ARMS, name="Full Bionic Upgrade",power_bonus=2)
...
class super_legs(BodyMod):
    def __init__(self) -> None:
        super().__init__(bodypart=BodyPart.LEGS, name="Enhanced Legs", speed_bonus=1)
...
class power_legs(BodyMod):
    def __init__(self) -> None:
        super().__init__(bodypart=BodyPart.LEGS, name="Stability Modules", power_bonus=2)
