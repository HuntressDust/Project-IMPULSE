...
class Entity:
    ...
    def spawn(self: T, gamemap: GameMap, x: int, y: int, force=False) -> T:
...
class Actor(Entity):
    ...
    def get_team(self) -> str:
        if hasattr(self.ai,"is_hostile"):
            return "Hostile"
        elif hasattr(self.ai,"is_ally"):
            return "Friendly"
        else:
            return "Neutral"
