...
def render_bars(
    ...
    console.draw_rect(x=0, y=47, width=total_width, height=1, ch=1, bg=color.fp_empty)
    if bar_width_hp>0:
        console.draw_rect(
    ...
    try:
        ...
        if bar_width_fp>0:
            console.draw_rect(
                x=0, y=47, width = bar_width_fp, height=1, ch=1, bg=color.fp
            )
...
def render_dungeon_level(
    ...
    if  dungeon_level<6:
        console.print(x=x, y=y, string=f"Office Floor, B{dungeon_level}")
    elif  dungeon_level<9:
        console.print(x=x, y=y, string=f"Warrens Zone, B{dungeon_level}")
    else:
        console.print(x=x, y=y, string=f"Salvation. B{dungeon_level}")
...
def render_danger_box(console: Console, x:int, y:int, radius:int) -> None:
