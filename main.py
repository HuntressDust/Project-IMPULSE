        ...
        try:
            while True:
                ...
                if hasattr(handler,"engine"):
                    ...
                    game_over=handler.engine.game_over
                try:
                ...
                if game_over:
                    game_over=False
                    score=handler.engine.player.level.score
                    name=handler.engine.playername
                    floor=handler.engine.game_world.current_floor
                    player_color=handler.engine.playercolor
                    del handler.engine
                    handler=setup_game.game_over_screen(score,floor,name,player_color)
